...
export LUA_PATH="$BASEDIR/../share/luajit-2.0.5/?.lua;$BASEDIR/../share/lua/$LUA_VER/?.lua;$BASEDIR/../share/lua/$LUA_VER/?/init.lua;$LUA_PATH"
...
exec "$BASEDIR/luajit" "$LUAROCKS_BIN_DIR/luarocks-admin.lua" "$@"
